  ...
  return (
    <div className='bg-background-darkBlack flex flex-col  relative h-[100dvh] justify-between text-white px-2 lg:px-8 py-4'>
      ...
      >
        ...
        {/* <div className='py-6 px-4 mx-auto h-full w-full relative bg-white/10 rounded-xl flex justify-center items-center'>
          <Avatar className='w-12 h-12 lg:w-32 lg:h-32'>
            <AvatarImage src='https://github.com/shadcn.png' />
            <AvatarFallback>
              <UserIcon className='w-28 h-2' />
        ...
        {/* {isVideoOpen
          ? Array.from({ length: counter }).map((_, index) => (
              ...
              >
                <div className='absolute inset-0 flex justify-center h-full'>
                  <video
                    ref={videoRef}
                    autoPlay
                    id='videoElement'
                    className={cn("object-cover rounded-xl", counter > 1 && "object-contain")}
                    playsInline
                  />
                  {counter > 1 && (
                    <div className='absolute top-0 h-32 w-full bg-gradient-to-b from-black/20 to-transparent'></div>
        ...
        {!isVideoOpen
          ? Array.from({ length: counter }).map((_, index) => (
              <div
                key={_ as any}
                className='py-6 px-4 mx-auto h-full w-full relative bg-white/10 rounded-xl flex justify-center items-center'
              >
                <Avatar className='w-12 h-12 lg:w-32 lg:h-32'>
                  <AvatarImage src='https://github.com/shadcn.png' />
                  <AvatarFallback>
        ...
        {/* {mediaStream?.getTracks() && isScreenShare
          ? Array.from({ length: counter }).map((_, index) => (
              <div
                key={_ as any}
                className=' py-6 mx-auto relative bg-white/10 rounded-xl flex justify-center items-center overflow-hidden px-10'
              >
